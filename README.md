...
4. Set build command: `npm run build` (or `bun run build`)
5. Set output directory: `.vercel/output/static` (generated by @cloudflare/next-on-pages)
6. Deploy: Cloudflare will automatically build and deploy
