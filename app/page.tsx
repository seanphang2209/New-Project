        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="card">
              ...
              <p className="text-gray-600">
                Whether you&apos;#39;#39;#39;#39;#39;#39;#39;re a small business carbon footprint calculator user or managing enterprise emissions, we provide relevant benchmarks for your industry and size.
              </p>
            </div>
            <div className="card">
            ...
            <div className="card">
              ...
              <p className="text-gray-600">
                Track your progress with our carbon footprint quiz and see how measuring your company&apos;#39;#39;#39;#39;#39;#39;#39;s carbon footprint leads to real business value.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="card mb-6">
              ...
              <p className="text-gray-700 mb-4">
                CarbonAtlas provides decision-support estimates to help you understand and measure your company&apos;#39;#39;#39;#39;#39;#39;#39;s carbon footprint. Our carbon footprint calculator for business is designed to be simple, clear, and actionable.
              </p>
              <p className="text-gray-700 mb-4">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose max-w-none">
            ...
            <p className="text-gray-700">
              Whether you&apos;#39;#39;#39;#39;#39;#39;#39;re calculating your business carbon footprint for the first time or looking to improve your existing carbon footprint calculator business program, CarbonAtlas provides the insights you need to measure business carbon footprint effectively and take meaningful action.
            </p>
          </div>
        </div>
      </section>
