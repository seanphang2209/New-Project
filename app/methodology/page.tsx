        ...
        <section className="mb-12">
          ...
          <div className="card">
            <ul className="space-y-4 text-gray-700">
              ...
              <li>
                <strong>Grid Factors:</strong> Grid emission factors are country-level averages and may not reflect your specific utility provider&apos;#39;#39;#39;#39;#39;#39;#39;s energy mix.
              </li>
            </ul>
          </div>
        </section>
